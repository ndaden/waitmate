  ...
  return (
    <div className="w-80 glass-panel rounded-2xl p-3 border border-slate-800 text-white select-none relative">
      ...
      <div className="flex items-center space-x-2.5 mb-2 pr-6">
        ...
        <div>
          ...
          <p className="text-[11px] text-slate-400 truncate max-w-[190px]">
            {stopPayload?.summary || "Réponse disponible."}
          </p>
        </div>
      </div>
      ...
      <div className="p-2.5 rounded-xl bg-slate-900/80 border border-emerald-500/20 flex items-center justify-between">
        ...
        {isNewHighScore ? (
          <div className="flex items-center space-x-1 px-2 py-0.5 rounded-md bg-amber-500/20 border border-amber-400/30 text-amber-300 text-[11px] font-bold">
